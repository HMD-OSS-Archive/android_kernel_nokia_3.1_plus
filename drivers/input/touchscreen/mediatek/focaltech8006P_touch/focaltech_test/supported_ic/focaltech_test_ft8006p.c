...
int fih_focal8006p_selftest_open(void)
{
	return 0;
}
int fih_focal8006p_selftest_read(void)
{

#if 0
    int ret = 0;

    ret = start_test_ft8006p();
...
void fih_focal8006p_tpfwver_read(char *fw_ver)
{
...
void fih_focal8006p_vendor_read(char *buf)
{
	sprintf(buf, "txd:%s\n","focal8006p");
