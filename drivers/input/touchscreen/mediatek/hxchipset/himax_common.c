...
extern int fih_himax_selftest_open(void);
extern int fih_touch_proc_init(void);
extern int fih_himax_selftest_read(void);
extern void fih_himax_tpfwver_read(char *);
//extern void touch_tpfwimver_read(char *fw_ver);
//extern void touch_fwupgrade(int);
//extern void touch_fwupgrade_read(char *);
extern void fih_himax_vendor_read(char *);
...
#if defined(HX_AUTO_UPDATE_FW) || defined(HX_ZERO_FLASH)
void get_firmware_name(void){
	if(strstr(saved_command_line,"hx83102_hd720plus_dsi_vdo_bflash_hlt") !=NULL)
		i_CTPM_firmware_name = "hlt_firmware_b.bin";
	if((strstr(saved_command_line,"hx83102_hd720plus_dsi_vdo_dflash_hlt") != NULL))
		i_CTPM_firmware_name = "hlt_himax1302_d.bin";
	if(strstr(saved_command_line, "hx83102_hd720plus_dsi_vdo_dzero_flash_hlt") !=NULL)
		i_CTPM_firmware_name = "hlt_himax1302_dzero.bin";
	if((strstr(saved_command_line, "hx83102_hd720plus_dsi_vdo_bflash_truly")!= NULL))
		i_CTPM_firmware_name = "truly_firmware_b.bin";
	if(strstr(saved_command_line, "hx83102_hd720plus_dsi_vdo_dflash_truly") !=NULL)
		i_CTPM_firmware_name = "truly_himax1302_d.bin";
	if((strstr(saved_command_line, "hx83102_hd720plus_dsi_vdo_dzero_flash_truly") != NULL))
		i_CTPM_firmware_name = "truly_himax1302_dzero.bin";
	if((strstr(saved_command_line, "txd_hd720plus_dsi_vdo_bflash") != NULL))
		i_CTPM_firmware_name = "txd_himax1302_bflash.bin";
	return ;
}
#endif
...
FW_force_upgrade:
    ...
    fih_touch_proc_init();
    touch_cb.touch_selftest = fih_himax_selftest_open;
    touch_cb.touch_selftest_result = fih_himax_selftest_read;
    touch_cb.touch_tpfwver_read = fih_himax_tpfwver_read;
...
//    touch_cb.touch_fwupgrade_read = touch_fwupgrade_read;
    touch_cb.touch_vendor_read = fih_himax_vendor_read;
    touch_cb.touch_double_tap_read = fih_himax_double_tap_read; //ZZDC-snow-Touch-ImplementDoubleTap-00+_20170807
   touch_cb.touch_double_tap_write = fih_himax_double_tap_write; //ZZDC-snow-Touch-ImplementDoubleTap-00+_20170807
