...
extern bool spi_dev_detected;
	...
	#define fw_data_criteria_aa_top	             0x5A
	#define fw_data_criteria_aa_bot	             0x0A
	#define fw_data_criteria_key_top	         0x5A
	#define fw_data_criteria_key_bot	         0x0A
	#define fw_data_criteria_avg_top	         0x5A
	#define fw_data_criteria_avg_bot	         0x0A
