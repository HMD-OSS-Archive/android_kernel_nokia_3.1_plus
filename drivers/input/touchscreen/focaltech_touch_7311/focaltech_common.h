...
#define FTS_DEBUG(fmt, args...) pr_debug("[FTS][%s]"fmt"\n", __func__, ##args)
#else
#define FTS_DEBUG(fmt, args...) pr_debug("[FTS]"fmt"\n", ##args)
#endif
...
#define FTS_INFO(fmt, args...) pr_info(KERN_INFO "[FTS][Info]"fmt"\n", ##args)
#define FTS_ERROR(fmt, args...) pr_info(KERN_ERR "[FTS][Error]"fmt"\n", ##args)
