...
struct IMGSENSOR_HW_CFG imgsensor_custom_config[] = {
	{
		...
		IMGSENSOR_I2C_DEV_0,
		{
			...
			{IMGSENSOR_HW_PIN_AFVDD, IMGSENSOR_HW_ID_REGULATOR}, //vcama2
	...
	},
	{
		...
		{
			{IMGSENSOR_HW_PIN_MCLK,  IMGSENSOR_HW_ID_MCLK},
			{IMGSENSOR_HW_PIN_AVDD,  IMGSENSOR_HW_ID_REGULATOR}, //SCAM_AVDD_2P85_EN, GPIO166
			{IMGSENSOR_HW_PIN_DOVDD, IMGSENSOR_HW_ID_REGULATOR}, //I2C, vcamio
...
#endif 
#if defined(S5K5E9QT_MIPI_RAW)
	{
		SENSOR_DRVNAME_S5K5E9QT_MIPI_RAW,
		{
		#if 0
			{SensorMCLK, Vol_High, 0},
			{PDN, Vol_Low, 0},
