...
static int chrlmt_lcmoff_policy_enable = 1; /**0: No lcmoff abcct */
...
struct notifier_block *self, unsigned long event, void *data)
{
	...
	case FB_BLANK_UNBLANK:
		...
		/*--s*/
		charger_manager_set_current_limit_lcm_onoff(pthermal_consumer,0,1000*1000);
		/*--e*/
		break;
		/* LCM OFF */
	case FB_BLANK_POWERDOWN:
		...
		/*--s*/
		charger_manager_set_current_limit_lcm_onoff(pthermal_consumer,0,-1);
		/*--e*/
		break;
	default:
		break;
