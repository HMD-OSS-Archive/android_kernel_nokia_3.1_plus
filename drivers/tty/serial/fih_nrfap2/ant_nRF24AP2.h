...
/*GaryTCShih added */
#define DRIVER_NAME "msm_serial_hs_fih_ant"
#define SLEEP_DELAY 100
#define NRFAP2_BPS 57600
...
#define DEBUG_LEVEL 2
    ...
    #define ANT_FUNC_START()            printk(KERN_ERR "NRFAP2 ------->  FUNC start %s", __FUNCTION__)
    #define ANT_FUNC_END()              printk(KERN_ERR "NRFAP2 <-------  FUNC end   %s", __FUNCTION__)
#else
    ...
    #define PERROR(fmt, args...) printk( KERN_ERR "NRFAP2 <Error>   " fmt, ## args)
#else
    #define PERROR(fmt, args...)   ((void)0)
#endif

#if DEBUG_LEVEL >= LEVEL_INFO
    #define PINFO(fmt, args...)  printk( KERN_ERR "NRFAP2 <INFO>   " fmt, ## args)
#else
    #define PINFO(fmt, args...)   ((void)0)
#endif

#if DEBUG_LEVEL >= LEVEL_DEBUG
    #define PDBG(fmt, args...)   printk( KERN_ERR "NRFAP2 <DEBUG>   " fmt, ## args)
#else
    #define PDBG(fmt, args...)   ((void)0)
#endif
/*GaryTCShih added */
...
/*GaryTCShih added  */
//overwrite from /include/linux/platform_data/msm_serial_hs.h
